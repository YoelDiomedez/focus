...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?= site_url('assets/pages/css/login.min.css'); ?>" rel="stylesheet" type="text/css" />
    ...
    <!-- END HEAD -->
    <body class="login" onload="sinVueltaAtras();" onpageshow="if (event.persisted) sinVueltaAtras();" onunload="">
    <!-- BEGIN LOGO -->
        <div class="logo">
            <img src="<?= site_url('resources/img/cca-logo.png'); ?>" alt="" width="150" /> </a>
        </div>
    <!-- END LOGO -->